...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex-1 p-10">
      ...
      >
        <h2 className={`text-2xl font-bold tracking-[-0.015em] text-white `}>
          Recents
        </h2>
        <button  
          onClick={() => setIsCreateDeploymentOPen(true)}
          className="flex min-w-[84px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-xl bg-red-500 h-12 px-6 text-base font-bold tracking-[0.015em] text-black transition-transform hover:scale-105"
        >
          <Plus size={26} />
